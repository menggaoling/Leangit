...
__vector_table2
        ...
        DCD     Loader_ADC1_IRQHandler               ; ADC1
        DCD     0                             ; Reserved
        DCD     0                             ; Reserved
        DCD     0                             ; Reserved
        DCD     0                             ; Reserved
        DCD     Loader_EXTI9_5_IRQHandler            ; EXTI Line 9..5
        DCD     Loader_TIM1_BRK_TIM15_IRQHandler     ; TIM1 Break and TIM15
        DCD     Loader_TIM1_UP_TIM16_IRQHandler      ; TIM1 Update and TIM16
        DCD     Loader_TIM1_TRG_COM_TIM17_IRQHandler ; TIM1 Trigger and Commutation and TIM17
        ...
        DCD     Loader_CEC_IRQHandler                ; HDMI-CEC
        DCD     0                             ; Reserved
        DCD     0                             ; Reserved
        DCD     0                             ; Reserved
        DCD     0                             ; Reserved
        ...
        DCD     0                             ; Reserved
        DCD     0                             ; Reserved                        
        DCD     Loader_TIM6_DAC_IRQHandler           ; TIM6 and DAC underrun
        DCD     Loader_TIM7_IRQHandler               ; TIM7                
...
Loader_DMA1_Channel7_IRQHandler
        ...
        PUBWEAK Loader_ADC1_IRQHandler
        SECTION .text:CODE:REORDER(1)
Loader_ADC1_IRQHandler
        B Loader_ADC1_IRQHandler
...
Loader_EXTI9_5_IRQHandler
        ...
        PUBWEAK Loader_TIM1_BRK_TIM15_IRQHandler
        SECTION .text:CODE:REORDER(1)
Loader_TIM1_BRK_TIM15_IRQHandler
        B Loader_TIM1_BRK_TIM15_IRQHandler

        PUBWEAK Loader_TIM1_UP_TIM16_IRQHandler
        SECTION .text:CODE:REORDER(1)
Loader_TIM1_UP_TIM16_IRQHandler
        B Loader_TIM1_UP_TIM16_IRQHandler

        PUBWEAK Loader_TIM1_TRG_COM_TIM17_IRQHandler
        SECTION .text:CODE:REORDER(1)
Loader_TIM1_TRG_COM_TIM17_IRQHandler
        B Loader_TIM1_TRG_COM_TIM17_IRQHandler
...
Loader_RTCAlarm_IRQHandler
        ...
        PUBWEAK Loader_CEC_IRQHandler
        SECTION .text:CODE:REORDER(1)
Loader_CEC_IRQHandler
        B Loader_CEC_IRQHandler

        PUBWEAK Loader_TIM6_DAC_IRQHandler
        SECTION .text:CODE:REORDER(1)
Loader_TIM6_DAC_IRQHandler
        B Loader_TIM6_DAC_IRQHandler

        PUBWEAK Loader_TIM7_IRQHandler
        SECTION .text:CODE:REORDER(1)
Loader_TIM7_IRQHandler
        B Loader_TIM7_IRQHandler                
