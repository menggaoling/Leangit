...
__vector_table
        ...
        DCD     Boot_ADC1_2_IRQHandler         ; ADC1 & ADC2
        DCD     Boot_USB_HP_CAN1_TX_IRQHandler  ; USB High Priority or CAN1 TX
        DCD     Boot_USB_LP_CAN1_RX0_IRQHandler ; USB Low  Priority or CAN1 RX0
        DCD     Boot_CAN1_RX1_IRQHandler       ; CAN1 RX1
        DCD     Boot_CAN1_SCE_IRQHandler       ; CAN1 SCE
        DCD     Boot_EXTI9_5_IRQHandler        ; EXTI Line 9..5
        DCD     Boot_TIM1_BRK_IRQHandler       ; TIM1 Break
        DCD     Boot_TIM1_UP_IRQHandler        ; TIM1 Update
        DCD     Boot_TIM1_TRG_COM_IRQHandler   ; TIM1 Trigger and Commutation
        ...
        DCD     Boot_USBWakeUp_IRQHandler      ; USB Wakeup from suspend
...
Boot_DMA1_Channel7_IRQHandler
        ...
        PUBWEAK Boot_ADC1_2_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_ADC1_2_IRQHandler
        B Boot_ADC1_2_IRQHandler

        PUBWEAK Boot_USB_HP_CAN1_TX_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_USB_HP_CAN1_TX_IRQHandler
        B Boot_USB_HP_CAN1_TX_IRQHandler

        PUBWEAK Boot_USB_LP_CAN1_RX0_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_USB_LP_CAN1_RX0_IRQHandler
        B Boot_USB_LP_CAN1_RX0_IRQHandler

        PUBWEAK Boot_CAN1_RX1_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_CAN1_RX1_IRQHandler
        B Boot_CAN1_RX1_IRQHandler

        PUBWEAK Boot_CAN1_SCE_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_CAN1_SCE_IRQHandler
        B Boot_CAN1_SCE_IRQHandler
...
Boot_EXTI9_5_IRQHandler
        ...
        PUBWEAK Boot_TIM1_BRK_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_TIM1_BRK_IRQHandler
        B Boot_TIM1_BRK_IRQHandler

        PUBWEAK Boot_TIM1_UP_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_TIM1_UP_IRQHandler
        B Boot_TIM1_UP_IRQHandler

        PUBWEAK Boot_TIM1_TRG_COM_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_TIM1_TRG_COM_IRQHandler
        B Boot_TIM1_TRG_COM_IRQHandler
...
Boot_RTCAlarm_IRQHandler
        ...
        PUBWEAK Boot_USBWakeUp_IRQHandler
        SECTION .text:CODE:REORDER(1)
Boot_USBWakeUp_IRQHandler
        B Boot_USBWakeUp_IRQHandler
